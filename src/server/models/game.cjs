...
let Game = new Schema({
  ...
  stateHistory: { type: [KlondykeGameState], default: [] },
  moveHistory: { type: [KlondykeGameState], default: [] },
  redoStack: { type: [KlondykeGameState], default: [] },
  game: {
    type: String,
    required: true,
  ...
  moveJSONS: { type: [Move.schema], default: [] },
});
